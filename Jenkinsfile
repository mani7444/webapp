  ...
  stages {
   ...
   // }
    ...
    stage ('Upload Reports to Defect Dojo') {
			...
			sh 'python upload-results.py --host 18.191.136.107:8080 --api_key d915aad678f94b1ca7fde4eb4016d8cc1d45a788 --engagement_id 1 --result_file trufflehog --username admin --scanner "SSL Labs Scan"'
